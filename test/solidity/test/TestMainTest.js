...
contract('TestMain', async accounts => {
    ...
    it('should decode msg2 (use soltype) correctly', async () => {
        ...
        assert.equal(receipt.logs[0].args.addr.toString().toLowerCase(), '0x0102030405060708090a0b0c0d0e0f1011121314');
        ...
        assert.equal(receipt.logs[0].args.numsLen.toString(), '3');
        assert.equal(receipt.logs[0].args.nums.toString(), [12, 34, 56]);
        const expectedAddrs = ['0x0102030405060708090a0b0c0d0e0f1011121314','0x0b0c0d0e0f10111213140102030405060708090a','0xff02030405060708090a0b0c0d0e0f1011121314'];
        assert.equal(receipt.logs[0].args.addrsLen.toString(), '3');
        assert.equal(receipt.logs[0].args.addrs.toString().toLowerCase(), expectedAddrs);

        assert.equal(receipt.logs[1].event, 'Msg2Part2');
        assert.equal(receipt.logs[1].args.amtsLen.toString(), '3');
    ...
    it('should decode msg3 (embedded msgs) correctly', async () => {
        ...
        assert.equal(receipt.logs[2].args.addr.toString().toLowerCase(), '0x0102030405060708090a0b0c0d0e0f1011121314');
        ...
        assert.equal(receipt.logs[2].args.numsLen.toString(), '3');
        assert.equal(receipt.logs[2].args.nums.toString(), [12, 34, 56]);
        expectedAddrs = ['0x0102030405060708090a0b0c0d0e0f1011121314','0x0b0c0d0e0f10111213140102030405060708090a','0xff02030405060708090a0b0c0d0e0f1011121314'];
        assert.equal(receipt.logs[2].args.addrsLen.toString(), '3');
        assert.equal(receipt.logs[2].args.addrs.toString().toLowerCase(), expectedAddrs);

        assert.equal(receipt.logs[3].event, 'Msg2Part2');
        assert.equal(receipt.logs[3].args.amtsLen.toString(), '3');
        ...
        assert.equal(receipt.logs[8].args.addr.toString().toLowerCase(), '0x0b0c0d0e0f10111213140102030405060708090a');
        ...
        assert.equal(receipt.logs[8].args.numsLen.toString(), '3');
        assert.equal(receipt.logs[8].args.nums.toString(), [12, 34, 56]);
        expectedAddrs = ['0x0102030405060708090a0b0c0d0e0f1011121314','0x0b0c0d0e0f10111213140102030405060708090a','0xff02030405060708090a0b0c0d0e0f1011121314'];
        assert.equal(receipt.logs[8].args.addrsLen.toString(), '3');
        assert.equal(receipt.logs[8].args.addrs.toString().toLowerCase(), expectedAddrs);

        assert.equal(receipt.logs[9].event, 'Msg2Part2');
        assert.equal(receipt.logs[9].args.amtsLen.toString(), '3');
        assert.equal(receipt.logs[9].args.amts.toString(), [1, 257, 65793]);
        expectedHs = ['0x0101010101010101010101010101010101010101010101010101010101010101','0x0202020202020202020202020202020202020202020202020202020202020202','0x0303030303030303030303030303030303030303030303030303030303030303'];
        assert.equal(receipt.logs[9].args.hsLen.toString(), '3');
        assert.equal(receipt.logs[9].args.hs.toString().toLowerCase(), expectedHs);
        assert.equal(receipt.logs[9].args.ts.toString(), '12345');
        assert.equal(receipt.logs[9].args.tssLen.toString(), '2');
        ...
        assert.equal(receipt.logs[10].args.addr.toString().toLowerCase(), '0xff02030405060708090a0b0c0d0e0f1011121314');
        ...
        assert.equal(receipt.logs[10].args.numsLen.toString(), '3');
        assert.equal(receipt.logs[10].args.nums.toString(), [12, 34, 56]);
        expectedAddrs = ['0x0102030405060708090a0b0c0d0e0f1011121314','0x0b0c0d0e0f10111213140102030405060708090a','0xff02030405060708090a0b0c0d0e0f1011121314'];
        assert.equal(receipt.logs[10].args.addrsLen.toString(), '3');
        assert.equal(receipt.logs[10].args.addrs.toString().toLowerCase(), expectedAddrs);

        assert.equal(receipt.logs[11].event, 'Msg2Part2');
        assert.equal(receipt.logs[11].args.amtsLen.toString(), '3');
        assert.equal(receipt.logs[11].args.amts.toString(), [1, 257, 65793]);
        expectedHs = ['0x0101010101010101010101010101010101010101010101010101010101010101','0x0202020202020202020202020202020202020202020202020202020202020202','0x0303030303030303030303030303030303030303030303030303030303030303'];
        assert.equal(receipt.logs[11].args.hsLen.toString(), '3');
        assert.equal(receipt.logs[11].args.hs.toString().toLowerCase(), expectedHs);
        assert.equal(receipt.logs[11].args.ts.toString(), '54321');
        assert.equal(receipt.logs[11].args.tssLen.toString(), '2');
    ...
    it('should decode msg4 (enum) correctly', async () => {
        ...
        assert.equal(receipt.logs[0].args.enumsLen.toString(), '3');
